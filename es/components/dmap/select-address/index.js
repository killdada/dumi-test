...
import { placeSearch, regeoCode, setupMap, getLnglat } from '../../utils/map'; // eslint-disable-next-line no-unused-vars

var Description = DescriptionList.Description;
import './index.css';
export var getNearbyAddress = function getNearbyAddress(searchKey) {
  var query = _objectSpread(
    _objectSpread({}, searchKey),
    {},
    {
      pageSize: 20
    }
...
export var getRegeoCode = function getRegeoCode(lnglat) {
  var result = regeoCode(lnglat)
    .then(function(res) {
      return res;
    })
    .catch(function(e) {
...
var DSelectAddress = /*#__PURE__*/ (function(_React$Component) {
  _inherits(DSelectAddress, _React$Component);

  var _super = _createSuper(DSelectAddress);

  function DSelectAddress(props) {
    var _this;

    _classCallCheck(this, DSelectAddress);
  ...
  _createClass(DSelectAddress, [
    ...
    },
    {
      key: 'searchAddress',
      value: (function() {
        var _searchAddress = _asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime.mark(function _callee2(keyword) {
    ...
    },
    {
      key: 'handleMap',
      value: (function() {
        var _handleMap = _asyncToGenerator(
                    ...
                    setTimeout(function() {
                      AMapUI.loadUI(['misc/PositionPicker'], function(PositionPicker) {
                        ...
                        if (lnglat.longitude === 0 && lnglat.latitude === 0) {
                          ...
                          _this3.positionPicker.start(getLnglat(lnglat));
                        }
