...
var TableItem = /*#__PURE__*/ (function(_React$Component) {
  (0, _inherits2.default)(TableItem, _React$Component);

  var _super = (0, _createSuper2.default)(TableItem);

  function TableItem(props) {
    var _this;

    (0, _classCallCheck2.default)(this, TableItem);
  ...
  (0, _createClass2.default)(TableItem, [
    {
      key: 'generateColumn',
